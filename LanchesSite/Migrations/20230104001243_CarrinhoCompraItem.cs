    ...
    public partial class CarrinhoCompraItem : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarrinhoCompraItns", x => x.CarrinhoCompraItemId);
                    table.ForeignKey(
                        name: "FK_CarrinhoCompraItns_Lanches_LancheId",
                        column: x => x.LancheId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarrinhoCompraItns_LancheId",
